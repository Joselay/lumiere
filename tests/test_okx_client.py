...
def test_parse_account_balances_includes_spot_btc_as_position() -> None:
    equity, available, position = _parse_account_balances(
        [
            {
                "totalEq": "1000",
                "details": [
    ...
    assert position.size_btc == Decimal("0.002")
